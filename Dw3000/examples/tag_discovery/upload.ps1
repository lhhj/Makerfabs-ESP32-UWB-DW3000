...
$DriverLib = (Resolve-Path (Join-Path $PSScriptRoot "..\..")).Path
...
Write-Host ""
Write-Host "Step 3: Compiling tag_discovery.ino..." -ForegroundColor Yellow
arduino-cli compile --fqbn $FQBN . --warnings none --verbose --clean --libraries $DriverLib
