# ESP32 UWB Anchor - Upload Script  
...
Write-Host "ESP32 UWB Anchor - Upload" -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "Step 3: Compiling anchor.ino..." -ForegroundColor Yellow
arduino-cli compile --fqbn $FQBN . --warnings none --verbose  --libraries $DriverLib
...
Write-Host "2. Power on your UWB tags (should be in range)" -ForegroundColor White
Write-Host "3. Watch for poll messages from tags" -ForegroundColor White
Write-Host "4. Anchor will respond to ranging requests" -ForegroundColor White
Write-Host ""
...
Write-Host "Or use: .\monitor.ps1" -ForegroundColor Cyan
Write-Host ""
